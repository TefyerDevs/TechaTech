...
import net.tefyert.techatech.api.block.cable.ConnectorType;
...
import static net.tefyert.techatech.api.block.cable.ConnectorType.*;
import static net.tefyert.techatech.main.client.BakedModelHelper.quad;
import static net.tefyert.techatech.main.client.BakedModelHelper.v;
import static net.tefyert.techatech.main.client.CablePatterns.SpriteIdx.*;
import static net.tefyert.techatech.main.client.CablePatterns.*;
...
public class CableBakedModel implements IDynamicBakedModel {
    ...
    private TextureAtlasSprite getTexture(String path) {
        return Minecraft.getInstance().getTextureAtlas(InventoryMenu.BLOCK_ATLAS).apply(new ResourceLocation(Techatech.MODID, path));
    }
